	...
	public byte[] gerarPlanilhaRedeEEFI(File arquivoParam) throws IOException, JRException {
		...
		try (BufferedReader arq = new BufferedReader(new FileReader(arquivo))){
			...
			if(registros034.size() > 0) {
				arquivos.add(jasper.exportReport(registros034, PATH_JASPER_034, PATH_CABECALHO, PATH_ARQUIVO_034));
			}
			if(registros035.size() > 0) {
				arquivos.add(jasper.exportReport(registros035, PATH_JASPER_035, PATH_CABECALHO, PATH_ARQUIVO_035));
			}
			if(registros036.size() > 0) {
				arquivos.add(jasper.exportReport(registros036, PATH_JASPER_036, PATH_CABECALHO, PATH_ARQUIVO_036));
			}
			if(registros038.size() > 0) {
				arquivos.add(jasper.exportReport(registros038, PATH_JASPER_038, PATH_CABECALHO, PATH_ARQUIVO_038));
			}
			if(registros043.size() > 0) {
				arquivos.add(jasper.exportReport(registros043, PATH_JASPER_043, PATH_CABECALHO, PATH_ARQUIVO_043));
			}
			if(registros044.size() > 0) {
				arquivos.add(jasper.exportReport(registros044, PATH_JASPER_044, PATH_CABECALHO, PATH_ARQUIVO_044));
			}
			if(registros045.size() > 0) {
				arquivos.add(jasper.exportReport(registros045, PATH_JASPER_045, PATH_CABECALHO, PATH_ARQUIVO_045));
			}
			if(registros046.size() > 0) {
				arquivos.add(jasper.exportReport(registros046, PATH_JASPER_046, PATH_CABECALHO, PATH_ARQUIVO_046));
			}
			if(registros047.size() > 0) {
				arquivos.add(jasper.exportReport(registros047, PATH_JASPER_047, PATH_CABECALHO, PATH_ARQUIVO_047));
			}
			if(registros048.size() > 0) {
				arquivos.add(jasper.exportReport(registros048, PATH_JASPER_048, PATH_CABECALHO, PATH_ARQUIVO_048));
			}
			if(registros049.size() > 0) {
				arquivos.add(jasper.exportReport(registros049, PATH_JASPER_049, PATH_CABECALHO, PATH_ARQUIVO_049));
			}
			if(registros053.size() > 0) {
				arquivos.add(jasper.exportReport(registros053, PATH_JASPER_053, PATH_CABECALHO, PATH_ARQUIVO_053));
			}
			if(registros054.size() > 0) {
				arquivos.add(jasper.exportReport(registros054, PATH_JASPER_054, PATH_CABECALHO, PATH_ARQUIVO_054));
			}
			if(registros055.size() > 0) {
				arquivos.add(jasper.exportReport(registros055, PATH_JASPER_055, PATH_CABECALHO, PATH_ARQUIVO_055));
			}
			if(registros056.size() >0) {
				arquivos.add(jasper.exportReport(registros056, PATH_JASPER_056, PATH_CABECALHO, PATH_ARQUIVO_056));
			}
			if(registros057.size() > 0) {
				arquivos.add(jasper.exportReport(registros057, PATH_JASPER_057, PATH_CABECALHO, PATH_ARQUIVO_057));
			}
			if(registros069.size() > 0) {
				arquivos.add(jasper.exportReport(registros069, PATH_JASPER_069, PATH_CABECALHO, PATH_ARQUIVO_069));
			}
